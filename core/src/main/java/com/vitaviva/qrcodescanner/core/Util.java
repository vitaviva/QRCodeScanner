...
public class Util {
    ...
    public static Bitmap WeChatBitmapToByteArray(Bitmap bmp, boolean needRecycle) {
    ...
    public static Bitmap decodeUri(Context context, Uri uri, int maxWidth, int maxHeight) {
        ...
        if (uri != null) {
            try {
                ...
                Log.e("wangp", "aa "+String.valueOf(bitmap.getByteCount()));
                Bitmap bitmap1 = WeChatBitmapToByteArray(bitmap, true);
                Log.e("wangp", "bb "+String.valueOf(bitmap1.getByteCount()));
                return bitmap1;
            } catch (IOException e) {
                e.printStackTrace();
            }
...
//        return bitmap;
    ...
    private static Bitmap resolveUriForBitmap(Context context, Uri uri, BitmapFactory.Options options) {
        ...
        if (ContentResolver.SCHEME_CONTENT.equals(scheme) ||
            ...
            try {
                stream = context.getContentResolver().openInputStream(uri);
                bitmap = BitmapFactory.decodeStream(new PatchInputStream(stream), null, options);
            } catch (Exception e) {
